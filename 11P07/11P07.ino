...
#define _DIST_ALPHA 0.27

#define _DUTY_MIN 496 // servo full clockwise position (0 degree)
#define _DUTY_NEU 1480 // servo neutral position (90 degree)
#define _DUTY_MAX 2464 // servo full counterclockwise position (180 degree)
...
float term; // _DUTY_MAX - _DUTY_MIN
...
// adjust servo position according to the USS read value
  if(dist_raw<=180) myservo.writeMicroseconds(_DUTY_MIN);
    ...
    myservo.writeMicroseconds(496+int(term/180.0*(dist_ema-dist_min)));
  }
